...
> 最后更新：2026-09-21 · 已同步截至 2026 年 9 月的 Agent 开发主线：模型路由、SDK、MCP、低代码/Agent 平台、可观测性、评测与就业冲刺项目。具体模型名称、治理状态和 SDK API 以官方文档为准。
...
本项目把「学 Agent 开发」整理成一条**循序渐进的路线**：从「什么是 Agent」讲起，到 LLM 原理、Prompt、ReAct、Tool Calling、RAG、记忆，再到 LangChain / LangGraph / MCP 等框架实战、多 Agent 系统设计与编排，最后展望 Agent OS、具身智能、AGI 等前沿方向。内容已同步至 **2026-09-21** 的主流实践：模型路由、OpenAI Agents SDK、LlamaIndex、MCP、Agent Skill、Computer Use、代码沙箱、低代码/Agent 平台与本地化运行能力。
...
- 完成全站日期与元信息同步：README、章节元数据、站点版本展示均已更新到 **2026-09-21**。
- 修正内容统计：当前为 **6 章 62 小节**、**195 道单元测验**、**6 套章节综合测验**。
...
6. **前沿趋势展望** - Agent OS、具身智能、AGI、多模态、Agent 安全、社区生态与就业冲刺包
...
| 第 6 章 前沿趋势 | 14h | ★★☆ | Agent OS、AGI、多模态、安全、社区生态、就业冲刺包 |
